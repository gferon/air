...
mod persistence {
    ...
    impl TryFrom<SqlMessageDraft> for MessageDraft {
        ...
        fn try_from(
            ...
            let in_reply_to = if let Some(mimi_id) = in_reply_to_mimi_id
                && let Some(message_id) = in_reply_to_message_id
            ...
            query_as!(
                ...
                r#"
                    ...
                    SELECT
                        ...
                        md.is_committed,
                        md.in_reply_to AS "in_reply_to_mimi_id: _",
                    ...
                    LEFT JOIN reply_targets rt ON rt.mimi_id = in_reply_to 
                    WHERE chat_id = ?
                "#,
                chat_id
            )
